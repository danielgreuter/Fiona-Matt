...
// Basis: v50 + v51: Finale-Events zuerst, Fiona-Block-Fallback (alle Bloecke statt nur Block 1), tolerantes Event-Parsing, Fehl-Diagnose
...
function candidatesFor(events, disc) {
  ...
  // Frauen-/Maedchen-Events zuerst, innerhalb davon Finale/Gesamt vor Vorlaeufen
  const wRe = /frauen|damen|m\u00e4dchen|maedchen|girls|wom|u\d+\s*w|w\s*u\d/i;
  const fRe = /finale?|gesamt|endlauf/i;
  const vRe = /vorlauf|vorl\u00e4ufe|vorlaeufe|serie|zeitlauf|heat/i;

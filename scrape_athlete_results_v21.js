// scrape_athlete_results_v21.js
// Fix: JS-Click via page.evaluate() — umgeht PrimeFaces AJAX-Overlay (Playwright actionability blockiert)
...
async function clickAnzeigen(page) {
  // Warten bis PrimeFaces AJAX-Overlay weg ist
  ...
  // JS-Click: umgeht Playwright-Actionability und PrimeFaces-Overlay
  ...
  if (clicked !== 'clicked') {
    console.log(`    ⚠ loadDataBtn: ${clicked}`);
    return false;
  }

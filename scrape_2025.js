...
const DISCIPLINES = [
  { key:'100m',      year:'2025', season:'Outdoor', label:'100 m' },
  { key:'60m',       year:'2025', season:'Indoor',  label:'60 m'  },
  { key:'200m',      year:'2025', season:'Outdoor', label:'200 m' },
  { key:'Long Jump', year:'2025', season:'Outdoor', label:'Weit'  },
];
...
(async () => {
  ...
  if (UPLOAD) {
    await uploadToKV('bestenliste_2025', output);
